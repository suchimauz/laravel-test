...
class EpisodeCrudController extends CrudController
{
    ...
    protected function setupShowOperation() {
        ...
        $this->crud->addColumns([
            ...
            ['name' => 'air_date', 'label' => 'Air Date', 'type' => 'datetime'],
            ['name' => 'characters', 'label' => 'Characters', 'type' => 'relationship'],
    ...
    {
        $this->crud->addColumn(['name' => 'title', 'type' => 'string']);
        $this->crud->addColumn(['name' => 'air_date', 'type' => 'datetime']);
